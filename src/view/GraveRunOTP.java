...
public class GraveRunOTP extends javax.swing.JFrame {
 ...
 private final String email;
    ...
    otpController.generateOTP(); // generates OTP and shows in message (you can remove JOptionPane later)
...
private void onChangePassword() {
    ...
    String otp = pin.getText()
               + pin1.getText()
               + pin2.getText()
               + pin3.getText();

    if (!otpController.verifyOTP(otp)) {
        javax.swing.JOptionPane.showMessageDialog(this, "Invalid OTP");
        return;
    }

    new GraveRunConfirmPassword(email).setVisible(true);
    this.dispose();
}
