 ...
 * @author Samsung
 */
public class GraveRunLogin extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GraveRunLogin.class.getName());

public GraveRunLogin(java.awt.Window parent, ModalityType modalityType) {
...
// Optional: Overload for old Frame + boolean (converts boolean to ModalityType)
public GraveRunLogin(java.awt.Frame parent, boolean modal) {
    this(parent, modal ? ModalityType.APPLICATION_MODAL : ModalityType.MODELESS);
}

// Optional: No-arg for testing
public GraveRunLogin() {
    ...
    public javax.swing.JTextField getSignuplink() {
        return signuplink;
    }
