...
/**
 * Favourites Page - Shows user's favorite products
 */
public class Favourites extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = 
        java.util.logging.Logger.getLogger(Favourites.class.getName());
    
    private FavoriteDAO favoriteDAO;

    /**
     * Default constructor - Gets user from SessionManager
     */
    public Favourites() {
        initComponents();
        
        // Initialize DAO (it gets userId from SessionManager internally)
    ...
    /**
     * Constructor with FavoriteDAO (for dependency injection)
     */
...
if (!SessionManager.isLoggedIn()) {
   ...
   if (!SessionManager.isLoggedIn()) {
    ...
    try {
        ...
        OrderTrackingController controller = new OrderTrackingController(trackingView, this);
        
        controller.loadMostRecentOrder(userId);
        controller.showScreen();
        
        this.setVisible(false); // Hide Favourites
    } catch (Exception e) {
        JOptionPane.showMessageDialog(
            this,
...
public javax.swing.JButton getProfileButton() {
    ...
    public JMenuItem getOrderMenu() {
        return Order;
    }

    /**
     * Adds a favourite panel to the product container
     */
    ...
    /**
     * Clears all panels from product container
     */
